export default function Sheet02Experience() {
  const experiences = [
    ...
    },
    {
      ...
      period: "Summer 2026",
      metrics: "Built an ARMv8 Firmware Image Package (FIP) with U-Boot, TF-A, and OP-TEE for NXP i.MX93 via SDP. Built custom ARM64 Linux kernels and rootfs using Buildroot & debootstrap with RAUC A/B updates."
    }
  ];
